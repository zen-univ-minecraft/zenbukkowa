...
public class SkillTreeLayout {
    ...
    private static final List<Node> NODES = List.of(
            ...
            new Node(SkillType.AREA_RADIUS, 11, 8),
            new Node(SkillType.AREA_DEPTH, 9, 8),
            new Node(SkillType.PILLAR_BREAK, 7, 8),
            new Node(SkillType.GRAVITY_WELL, 5, 6),
            new Node(SkillType.TERRA_BLESSING, 3, 8),
            new Node(SkillType.HASTE_AURA, 11, 10),
            new Node(SkillType.FORTUNE_TOUCH, 9, 10),
            new Node(SkillType.VEIN_MINER, 7, 10),
            new Node(SkillType.MAGNET, 5, 10),
            new Node(SkillType.CRYSTAL_VISION, 3, 10),
            new Node(SkillType.BLAST_MINING, 1, 10),
            ...
            new Node(SkillType.TIDE_BREAKER, 11, 13),
            new Node(SkillType.SALVAGE, 11, 15),
            new Node(SkillType.CONDUIT_AURA, 7, 13),
            new Node(SkillType.FROST_WALKER, 9, 14),
            new Node(SkillType.DEEP_DIVE, 3, 13),
            new Node(SkillType.TSUNAMI, 1, 13),
            new Node(SkillType.VOID_SIPHON, 11, 16),
            new Node(SkillType.STRUCTURE_SENSE, 11, 17),
            new Node(SkillType.NIGHT_VISION, 7, 17),
            new Node(SkillType.FIRE_RESISTANCE, 3, 17),
            new Node(SkillType.VOID_WALK, 7, 16),
            new Node(SkillType.VOID_RIFT, 3, 16),
            ...
            new Node(SkillType.EFFICIENCY, 10, 6)
    );
    ...
    private static Map<SkillType, SkillType> buildParents() {
        ...
        map.put(SkillType.GRAVITY_WELL, SkillType.PILLAR_BREAK);
