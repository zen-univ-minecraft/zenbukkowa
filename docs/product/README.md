...
Define player-facing behavior for point categories, skills, block breaking, menus, scoreboard, and event flow.
...
- [skills/README.md](skills/README.md): skill tree and purchase rules
